<template>
    ...
    export default {
      ...
      methods: {
        ...
        .then((res) => {
            this.option1.series[0].data[0].value=res.data['student_num'];
            this.option1.series[0].data[1].value=res.data['teacher_num'];
            this.option1.series[0].data[2].value=res.data['schoolmate_num'];
        });
        this.$axios({
        method: "get" ,
        ...
        .then((res) => {
            this.option2.dataset.source[1][1]=res.data['school_num'];
            this.option2.dataset.source[1][2]=res.data['enterprise_num'];
            this.option2.dataset.source[1][3]=res.data['lab_num'];
        });
        this.$axios({
        method: "get" ,
        ...
        .then((res) => {
            this.option3.dataset.source[1][1]=res.data['num1'];
            this.option3.dataset.source[1][2]=res.data['num2'];
            this.option3.dataset.source[1][3]=res.data['num3'];
            this.option3.dataset.source[1][4]=res.data['num4'];
            this.option3.dataset.source[1][5]=res.data['num5'];
        });
        this.$axios({
        method: "get" ,
        ...
        .then((res) => {
            this.option4.series[0].data[0].value=res.data['num1'];
            this.option4.series[0].data[1].value=res.data['num2'];
            this.option4.series[0].data[2].value=res.data['num3'];
            this.initChart();
        })
        }
      },
